...
int main(void)
{
	...
	MyList_dyn->InsertFront(-1154);
	MyList_dyn->InsertFront(211);
	MyList_dyn->InsertFront(-114);
	MyList_dyn->InsertFront(-11554);
	MyList_dyn->InsertFront(2116);
	MyList_dyn->test();
	cout << MyList_dyn;
